...
const currentUser = JSON.parse(localStorage.getItem('user') || '{}');
                ...
                const userCommandes = allCommandes.filter(cmd => cmd.userId === user.id);
    ...
    const menuItems = [
        ...
        try {
            ...
            const users = JSON.parse(localStorage.getItem('users') || '[]');            const updatedUsers = users.map(user => 
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        }}>                            <p style={{ color: '#5a6c57', fontSize: '1rem', lineHeight: '1.6' }}>
                                <strong>Adresse actuelle :</strong><br />
                                {userData?.adresse || userData?.ville || userData?.codePostal ? (
                                    <>
                                        {userData.adresse && <>{userData.adresse}<br /></>}
                        ...
                        {showAddressForm && (                            <form onSubmit={handleAdresseSubmit} style={{
                                display: 'flex',
                                flexDirection: 'column',
                                gap: '1rem',
