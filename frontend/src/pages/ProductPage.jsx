...
const ProductPage = () => {
    ...
    const fetchProduct = async () => {
      try {
        const response = await axios.get(
          `http://localhost:9090/api/produits/${id}`
        );
  ...
  const getFallbackImage = (product) => {
    ...
    return (
      typeImages[product.idTypeOeuvre] ||
  ...
  const handleImageError = () => {
    console.log(
      "❌ Erreur chargement image depuis public/images/. Utilisation du fallback."
    );
    setImageError(true);
  };
  ...
  return (
    <div style={{ fontFamily: "system-ui, -apple-system, sans-serif" }}>
      ...
      >
          ...
          <div style={{ flex: 1, paddingLeft: "1.5rem" }}>
            ...
            <div style={{ marginBottom: "2rem" }}>
              ...
              <select
                ...
                style={{
                  ...
                  color: "#2c3e2d",
                  cursor:
                    !isLoggedIn || !product.stock ? "not-allowed" : "pointer",
                }}
              >
            ...
            >
              ...
              {showDescription && (
                ...
                >
                  {product.description ||
                    "Ce magnifique produit artisanal a été créé avec soin et attention aux détails. Chaque pièce est unique et reflète l'expertise de notre atelier."}
                </div>
              )}
            </div>
          </div>
        ...
        <div
          style={{ maxWidth: "1100px", margin: "0 auto", marginTop: "5rem" }}
        >
            ...
            {[
              {
                ...
                date: "01/03/2025",
                stars: 5,
                comment: "Produit magnifique, exactement comme sur la photo !",
              },
              {
                name: "Milena K.",
                date: "05/01/2025",
                stars: 5,
                comment:
                  "Travail artisanal de qualité, je recommande vivement.",
              },
              {
                name: "Catherine L.",
                date: "16/12/2024",
              ...
              },
              {
                ...
                date: "23/11/2024",
                stars: 5,
                comment: "Parfait pour offrir, emballage soigné.",
              },
            ].map((review, index) => (
              <div
                key={index}
